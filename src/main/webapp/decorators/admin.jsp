	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="two" class="collapse" aria-labelledby="headingTwo"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="/Blog/post/view">Thống kê</a>
					</div>
				</div></li>
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="three" class="collapse" aria-labelledby="headingTwo"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="/Blog/category/view">Thống kê</a>
					</div>
				</div></li>
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				data-toggle="collapse" data-target="#four" aria-expanded="true"
				aria-controls="collapseTwo"> <i class="fas fa-tags"></i> <span>Thẻ
						tag</span>
			</a>
				<div id="four" class="collapse" aria-labelledby="headingTwo"
					data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">Thẻ tag</h6>
						<a class="collapse-item" href="/Blog/hashtag/view">Thống kê</a>
					</div>
				</div></li>
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				data-toggle="collapse" data-target="#eight" aria-expanded="true"
				aria-controls="collapseTwo"> <i class="fas fa-tags"></i> <span>Bình
						luận</span>
			</a>
				<div id="eight" class="collapse" aria-labelledby="headingTwo"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="/Blog/comment/view">Thống kê</a>
					</div>
				</div></li>

			<li class="nav-item"><a class="nav-link collapsed" href="#"
				data-toggle="collapse" data-target="#five" aria-expanded="true"
				aria-controls="collapseTwo"> <i class="fas fa-user-alt"></i> <span>Quản
						trị viên</span>
			</a>
				<div id="five" class="collapse" aria-labelledby="headingTwo"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="/Blog/admin/view">Thống kê</a>
					</div>
				</div></li>
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="seven" class="collapse" aria-labelledby="headingTwo"
					data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">Tag bài đăng</h6>
						<a class="collapse-item" href="/Blog/posthashtag/view">Thống
							kê</a>
					</div>
				</div></li>
			...
			<li class="nav-item"><a class="nav-link" href="charts.html">
					<i class="fas fa-fw fa-chart-area"></i> <span>Biểu đồ</span>
			</a></li> -->
			<!-- Nav Item - Tables -->
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false"> <span
								class="mr-2 d-none d-lg-inline text-gray-600 small">Đang
									trong phiên đăng nhập</span> <img class="img-profile rounded-circle"
							...
							<div
								...
								<a class="dropdown-item"
									...
									class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i> Đăng
									xuất
								</a>
