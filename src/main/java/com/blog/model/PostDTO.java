...
public class PostDTO {
	...
	public PostDTO(String id, String title, String content, String author, String date, String img, String id_category,
	...
	public PostDTO(String id, String title, int soLuongBinhLuan) {
		super();
		this.id = id;
		this.title = title;
		this.soLuongBinhLuan = soLuongBinhLuan;
